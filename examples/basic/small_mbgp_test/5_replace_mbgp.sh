...
LOCAL_MBGP_C=/home/bashayer/seed-emulator-mbgp/examples/basic/small_mbgp_test/bird/proto/mbgp/mBGP/mbgp_connector.cc
LOCAL_EVENT_C=/home/bashayer/seed-emulator-mbgp/examples/basic/small_mbgp_test/bird/proto/mbgp/mBGP/mbgp_connector.h
...
for container in "${routers[@]}"; do
  ...
  docker exec "$container_id" rm -f /bird/proto/mbgp/mBGP/mbgp_connector.cc
