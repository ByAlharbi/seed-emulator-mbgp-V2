...
LOCAL_MBGP_DIR=/home/bashayer/seed-emulator-mbgp/examples/basic/small_mbgp_test/bird/proto
...
#  as152r-router0-10.152.0.254
  as141r-router0-10.141.0.254 
  as142r-router0-10.142.0.254
  as143r-router0-10.143.0.254
  as144r-router0-10.144.0.254
)
...
for container in "${routers[@]}"; do
  ...
  docker exec "$container_id" rm -rf /bird/proto

  echo "📁 Copying local mbgp folder to $container..."
  docker cp "$LOCAL_MBGP_DIR" "$container_id":/bird/proto
