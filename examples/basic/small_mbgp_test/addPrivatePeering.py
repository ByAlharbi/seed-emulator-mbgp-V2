...
def run(dumpfile = None):
   ...
   # Create an Internet Exchange
    ...
    mbgp.addPrivatePeering(109, 141, 142, abRelationship=PeerRelationship.Unfiltered)
    mbgp.addPrivatePeering(109, 142, 143, abRelationship=PeerRelationship.Unfiltered)
    mbgp.addPrivatePeering(109, 143, 144, abRelationship=PeerRelationship.Unfiltered)
    ###############################################################################
    # Rendering 
