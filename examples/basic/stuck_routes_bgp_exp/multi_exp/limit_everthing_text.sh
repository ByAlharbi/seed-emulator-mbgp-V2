...
SHUTDOWN_OFFSET=0.3  # Seconds after route configuration to trigger 149 shutdown
...
run_first_experiment() {
    ...
    #docker exec as150r-router0-10.150.0.254 tc qdisc del dev ix100 root 2>/dev/null
    #docker exec as150r-router0-10.150.0.254 tc qdisc add dev ix100 root tbf rate 5kbit burst 32kbit latency 400ms
...
'🎉 All $TOTAL_EXPERIMENTS experiments completed successfully!${NC}"'
