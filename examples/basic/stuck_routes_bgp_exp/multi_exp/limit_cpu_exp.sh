...
echo "⚠️ Limiting CPU of Router 150 to simulate resource pressure..."
docker update --cpus="0.05" as150r-router0-10.150.0.254
...
main
echo "✅ Restoring CPU of Router 150 after experiment..."
docker update --cpus="1.0" as150r-router0-10.150.0.254
