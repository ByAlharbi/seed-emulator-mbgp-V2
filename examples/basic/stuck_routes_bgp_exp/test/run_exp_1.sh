...
# === Step 4: Generate unique pcap filename ===
i=1
...
# === Step 6: Start BIRD in all routers at once ===
...
# === Step 8: Determine next experiment number ===
...
# === Step 9: Capture and append route counts ===
