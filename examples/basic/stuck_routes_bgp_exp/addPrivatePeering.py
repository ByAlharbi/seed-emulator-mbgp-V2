...
def run(dumpfile = None):
   ...
   # Create an Internet Exchange
    ...
    as151 = base.createAutonomousSystem(152)
    as151.createNetwork('net0')
    as151.createRouter('router0').joinNetwork('net0').joinNetwork('ix100')
    ...
    ebgp.addPrivatePeering(100, 151, 11872, abRelationship=PeerRelationship.Unfiltered)
    
    # Mbgp Peering (Private Peering)
    ebgp.addPrivatePeering(100, 149, 150, abRelationship=PeerRelationship.Unfiltered)
