...
LOCAL_MBGP_C=/home/bashayer/seed-emulator-mbgp/examples/basic/stuck_routes_mbgp_exp/bird/proto/mbgp/mbgp.c
...
routers=(
  ...
  as154r-router0-10.154.0.254
  as155r-router0-10.155.0.254
)
