...
def run(dumpfile = None):
    ...
    base.createInternetExchange(100)  # IX between R1-R2 and R1-R4
    base.createInternetExchange(101)  # IX between R2-R3
    base.createInternetExchange(102)  # IX between R4-R5
    base.createInternetExchange(103)  # IX between R5-R3
    base.createInternetExchange(104)  # IX between R3-R6
