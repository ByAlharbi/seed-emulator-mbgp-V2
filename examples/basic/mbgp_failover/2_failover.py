...
def run(dumpfile = None):
    ...
    ###############################################################################
    # Create one Internet Exchange for all connections
    ...
    ###############################################################################
    # Configure MBGP with selective peering to create the desired topology
    
    # Primary Path: R1 -> R2 -> R3 -> R6
    mbgp.addPrivatePeering(100, 150, 151, abRelationship=PeerRelationship.Unfiltered)
    mbgp.addPrivatePeering(100, 151, 152, abRelationship=PeerRelationship.Unfiltered)
    mbgp.addPrivatePeering(100, 152, 155, abRelationship=PeerRelationship.Unfiltered)
    
    # Backup Path: R1 -> R4 -> R5 -> R3 -> R6
    mbgp.addPrivatePeering(100, 150, 153, abRelationship=PeerRelationship.Unfiltered)
    mbgp.addPrivatePeering(100, 153, 154, abRelationship=PeerRelationship.Unfiltered)
    mbgp.addPrivatePeering(100, 154, 152, abRelationship=PeerRelationship.Unfiltered)
